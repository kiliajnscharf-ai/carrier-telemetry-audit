...
if __name__ == "__main__":
    ...
    ai.run()
"""
    with open("global_market_ai.py", "w", encoding="utf-8") as f:
        f.write(code)
    print("Skript 'global_market_ai.py' für den gesamten Weltmarkt wurde erfolgreich erstellt.")

if __name__ == "__main__":
    generate_global_market_ai()
